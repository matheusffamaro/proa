...
<section class="posts__mobile d-mobile">
  <div class="container">
    <div class="slide__wrapper swiper-container slide-blog d-mobile" style="margin: 0;">
      <div class="swiper-wrapper">
        <?php if($posts_slide) : ?>
        <?php foreach($posts_slide as $post) : ?>
        <?php 
        ...
        <div class="slide__item swiper-slide">
          ...
          <p class="post__res">Por todo o mundo, a COVID-19 tem afetado a sociedade nos mais diversos aspectos, e alguns
            especialistas preveem que o impacto da pandemia…</p>
          <a href="<?= $post_url ?>" class="post__view">Ver notícia</a>
        </div>
...
<section class="categories">
  <div class="container">
    <ul>
      <li class="activeMenu"><a href="<?= get_post_permalink(94) ?>">Geral</a></li>
