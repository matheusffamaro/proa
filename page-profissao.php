...
<section class="vaiaprender">
  <div class="container">
    <div class="grid">
      <div class="materiais">
        <h2><?= checkLang() ? 'Want to learn to program?' : 'O que você vai aprender?' ?></h2>
...
<section class="post__others">
  <div class="container">
    ...
    <?php if(!checkLang()) : ?>
    <a href="<?php echo esc_url(get_post_permalink(94)) ?>"
      class="btn-mini"><?= checkLang() ? 'View more' : 'Ver mais' ?></a>
    <?php endif; ?>
  </div>
</section>
